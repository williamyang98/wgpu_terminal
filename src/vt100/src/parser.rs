    ...
    fn read_common_private_mode(&mut self, b: u8, h: &mut impl ParserHandler) {
        ...
        for i in 0..total_numbers {
            ...
            match (n, b) {
                ...
                (1001, b'h') => self.on_success(h, Command::SetHighlightMouseTracking(true)),
                (1001, b'l') => self.on_success(h, Command::SetHighlightMouseTracking(false)),
                ...
                (1005, b'l') => self.on_success(h, Command::SetMouseCoordinateFormat(MouseCoordinateFormat::Normal)),
                (1006, b'h') => self.on_success(h, Command::SetMouseCoordinateFormat(MouseCoordinateFormat::Sgr)),
                (1006, b'l') => self.on_success(h, Command::SetMouseCoordinateFormat(MouseCoordinateFormat::Normal)),
                (1015, b'h') => self.on_success(h, Command::SetMouseCoordinateFormat(MouseCoordinateFormat::Urxvt)),
                (1015, b'l') => self.on_success(h, Command::SetMouseCoordinateFormat(MouseCoordinateFormat::Normal)),
                (1016, b'h') => self.on_success(h, Command::SetMouseCoordinateFormat(MouseCoordinateFormat::SgrPixel)),
                (1016, b'l') => self.on_success(h, Command::SetMouseCoordinateFormat(MouseCoordinateFormat::Normal)),
